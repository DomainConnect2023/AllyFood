                    ...
                    <View style={{ alignItems: 'flex-start', justifyContent: 'center', flex: 1, flexGrow: 1, }}>
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            <Text style={css.text2ndHeader}>
                                {i18n.t('ForeCast.Yesterday-Amount')}: {setNumberFormat2(item.yesterdayTotalAmount)}
                            </Text>
                            {/* <Text style={[css.textDescription,{textAlign:"right"}]}></Text> */}
                        </View>
                        <View style={{ flexDirection: 'row', }}>
                            <Text style={css.text2ndHeader}>
                                {i18n.t('ForeCast.Today-Rental')}: {setNumberFormat2(item.todayRental)}
                            </Text>
                            {/* <Text style={[css.textDescription,{textAlign:"right"}]}>
                                100000%
                            </Text> */}
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            <Text style={css.text2ndHeader}>
                                {i18n.t('ForeCast.Today-GR')}: {setNumberFormat2(item.todayGR)}
                            </Text>
                            {/* <Text style={[css.textDescription,{textAlign:"right"}]}></Text> */}
                        </View>
                        <View style={{ flexDirection: 'row', }}>
                            <Text style={css.text2ndHeader}>
                                {i18n.t('ForeCast.Today-GI')}: {setNumberFormat2(item.todayGI)}
                            </Text>
                            {/* <Text style={[css.textDescription,{textAlign:"right"}]}></Text> */}
                        </View>
                        <View style={{ flexDirection: 'row', }}>
                            <Text style={css.text2ndHeader}>
                                {i18n.t('ForeCast.Total-Amount')}: {setNumberFormat2(item.todayTotalAmount)}
                            </Text>
                            {/* <Text style={[css.textDescription,{textAlign:"right"}]}></Text> */}
                        </View>
                        <View style={{ flexDirection: 'row', }}>
                            <Text style={css.text2ndHeader}>
                                {i18n.t('ForeCast.Month-Amount')}: {setNumberFormat2(item.monthEndTotalAmount)}
                            </Text>
                            {/* <Text style={[css.textDescription,{textAlign:"right"}]}></Text> */}
                        </View>
                    </View>
