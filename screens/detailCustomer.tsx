                    ...
                    <View style={[css.cardBody]}>
                        <View style={{ alignItems: 'flex-start', justifyContent: 'center', flex: 1, flexGrow: 1, }}>
                            <View style={{ flexDirection: 'row', }}>
                                <Text style={css.textHeader}>{i18n.t('Detail-Customer.Product')}: {item.key} {item.name != "" ? "(" + item.name + ")" : ""}</Text>
                                <Text style={css.textDescription}>
                                    <CircleColorText color={item.color} />
                                </Text>
                            </View>
                            <Text style={css.textHeader}>{i18n.t('Detail-Customer.Weight')}: {currencyFormat(parseInt(item.amount))}</Text>
                        </View>
                    </View>
                </View>
            </TouchableOpacity>
                ...
                <View style={css.listItem} key={parseInt(item.key)}>
                    <View style={[css.cardBody]}>
                        <View style={{ alignItems: 'flex-start', justifyContent: 'center', flex: 1, flexGrow: 1, }}>
                            ...
                            <Text style={css.textHeader}>{i18n.t('Detail-Customer.Day-of-Total-Weight')}: {currencyFormat(parseInt(item.amount))}</Text>
                        </View>
                    </View>
                </View>
            </TouchableOpacity>
            ...
            <KeyboardAvoidWrapper>
                <View style={css.mainView}>
                    ...
                    <View style={css.HeaderView}>
                        <Text numberOfLines={2} style={css.PageName}>{i18n.t('Detail-Customer.Customer')}: {customerName}</Text>
                    </View>
                </View>
                ...
                <View>
                    ...
                    {showPicker && Platform.OS === "ios" && (
                        ...
                        >
                            ...
                            >
                                <Text style={[datepickerCSS.cancelButtonText, { color: "#075985" }]}>{i18n.t('Detail-Customer.Cancel')}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[datepickerCSS.cancelButton, { paddingHorizontal: 20 }]}
                                onPress={confirmIOSDate}
                            >
                                <Text style={[datepickerCSS.cancelButtonText]}>{i18n.t('Detail-Customer.Confirm')}</Text>
                            </TouchableOpacity>
                        </View>
                    )}
                </View>
                                ...
                                {chooseChart == "pie" ? (
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <View style={{ margin: 10, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>{i18n.t('Detail-Customer.Total-Weight')}: {currencyFormat(totalWeight)}</Text>
                                        </View>
                                    </View>
                                ) : (
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <View>
                            {fetchedData.length == 0 ? (
                                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                    ...
                                    />
                                    <Text style={{ fontSize: 16, margin: 30 }}>{i18n.t('Detail-Customer.No-Data')}</Text>
                                </View>
                            ) : (
                                <TouchableOpacity onPress={async () => [setChooseChart("pie"), toggleSlide()]}>
                                    <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <View style={{ margin: 10, alignItems: 'center', justifyContent: 'center' }}>
                                            <Text style={{ fontSize: 18, fontWeight: 'bold' }}>{i18n.t('Detail-Customer.Total-Weigth')}: {currencyFormat(totalWeight)}</Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                            )}
                ...
                chooseChart == "pie" ? (
                    <Animated.View style={[{ transform: [{ translateY: bounceValue }], padding: 15 }]}>
                        <View style={{ alignItems: 'center', justifyContent: 'center', height: Dimensions.get("screen").height / 100 * 35 }}>
                            <View style={{ width: "85%", alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                                <Text style={{ fontSize: 20, fontWeight: 'bold' }}>{i18n.t('Detail-Customer.Net-Weight-List')}:</Text>
                            </View>
                            <View>
                                <FlatList
                                    data={fetchedData}
                    ...
                    <Animated.View style={[{ transform: [{ translateY: bounceValue }], padding: 15 }]}>
                        <View style={{ alignItems: 'center', justifyContent: 'center', height: Dimensions.get("screen").height / 100 * 40 }}>
                            <View style={{ width: "85%", alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                                <Text style={{ fontSize: 20, fontWeight: 'bold' }}>{i18n.t('Detail-Customer.Last-4-Day-Review')}:</Text>
                            </View>
                            <View>
                                <FlatList
                                    data={fetchedBarData}
